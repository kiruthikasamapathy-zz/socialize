...
$search = array('bootstrap.min.css', 'bootstrap-responsive.min.css', 'bootstrap-extended.css');
// remove the bootstrap-2 css files
foreach($this->_styleSheets as $key => $script) {
